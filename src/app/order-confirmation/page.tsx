  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8">
      <div className="max-w-4xl mx-auto bg-white p-6 rounded shadow-lg">
        ...
        <p className="text-lg text-center mb-6">Thank you for your purchase! Your order has been confirmed.</p>
        ...
        <div className="bg-gray-50 p-6 rounded mb-6 shadow-md">
          ...
          <p className="text-gray-700 mb-4">Total: ${orderDetails.total.toFixed(2)}</p>

          <h3 className="text-lg font-semibold mb-2">Shipping Information</h3>
          <p>{orderDetails.shippingAddress.fullName}</p>
          <p>{orderDetails.shippingAddress.addressLine1}, {orderDetails.shippingAddress.addressLine2}</p>
